...
from LIB_Horizon import kretschmann_scalar, readfiledouble, readfilesingle, solve_y9
...
def b_lambda(u_var, x_var):
    return gamma * u_var * np.exp(-(u_var**2) / w0**2)


def lam_1_lambda(u_var, x_var):
    return 0 * x_var + 0.5
